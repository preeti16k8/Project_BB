...
public class SetProfile extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private static final int CAMERA_CODE = 1888, GALLERY_CODE = 201, CROPING_CODE = 301;
    ...
    private int IMAGE_PERMISSION_CODE = 12;
    ...
    public static int counterrename;
    boolean b=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // calculated_age= Integer.parseInt(age.getResult());
        ...
        if(isNetworkAvailable(SetProfile.this))
...
//            editTextDOB.setText(""+selectedDay+":"+(startMonth+1)+":"+startYear);
    ...
    * */
    public void uploadMultipart() {
        ...
        for (int i = 0; i < 1; i++) {
            String rename = String.valueOf(counterrename++);
            saveToCacheFile(photo, "+91" + userPhone + rename);
            //getting the actual path of the image
            //   final String path = getCacheFilename("+91" + userPhone);
            path = getCacheFilename("+91" + userPhone + rename);
        }


      /*  saveToCacheFile(photo, "+91" + userPhone);
        //getting the actual path of the image
        final String path = getCacheFilename("+91" + userPhone);
*/
                   ...
                   // .setNotificationConfig(new UploadNotificationConfig())
                    ...
                    public void onError(UploadInfo uploadInfo, Exception exception) {
                        try {
                            ...
                            Toast.makeText(SetProfile.this, "Please Try Again", Toast.LENGTH_SHORT).show();
                        } catch (Exception ignored) {
...
//                                Toast.makeText(SetProfile.this, serverResponse.getBodyAsString(),Toast.LENGTH_LONG).show();
                ...
                File file = new File(getCacheFilename("+91" + userPhone));
                boolean delete = file.delete();
                boolean deletepath = PictUtil.getSavePath().delete();
                boolean deleteoutput = outPutFile.delete();
                Intent main = new Intent(SetProfile.this, StoreActivity.class);
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, listPermissionsNeeded.get(0))) {
                    ...
                    alertBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(SetProfile.this, listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]), MULTIPLE_PERMISSIONS);
                        }
                    });
...
public void openImage(){
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Capture Photo")) {
                   ...
                   /* if (checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) ==
                        ...
                        openImage();
                    } else { //permission failed. request String[] permissionRequest ={Manifest.permission.READ_EXTERNAL_STORAGE}
                        requestPermissions(permissionRequest, CAMERA_CODE);
                    }*/
    ...
    private Bitmap decodeFile(File f) {
        try {
            ...
            Toast.makeText(SetProfile.this,"Error"+e, Toast.LENGTH_LONG).show();
        }
        return null;
    }
    ...
    public class noImage extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (updateResponse != null) {
                ...
                try {
                    Log.d("SetProfileResponse", updateResponse);
                    ...
                    if (jsonObject.getString("success").equals("1")) {
                        ...
                        Intent in=new Intent(SetProfile.this,StoreActivity.class);
                        in.putExtra("phone", getIntent().getStringExtra("phone"));
                        in.putExtra("customer_id",userid);
                        startActivity(in);
                ...
                Toast.makeText(getApplicationContext(), "Please Try after uninstalling it!", Toast.LENGTH_SHORT).show();
