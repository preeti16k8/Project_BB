...
public class ViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    ViewPager viewPager;
    TabLayout tabLayout;
    public ViewPagerAdapter(FragmentManager fm, FragmentActivity activity, ViewPager viewPager, TabLayout tabLayout) {
        super(fm);
    }
    ...
    public void removeAllFrag() {
        ...
        for (int i =0;i<mFragmentList.size();i++)
        {
            ...
            destroyFragmentView(viewPager, i, fragment);
            notifyDataSetChanged();
        }
    ...
    public View getTabView(final int position) {
        ...
        TextView tabItemName = (TextView) view.findViewById(R.id.text);
